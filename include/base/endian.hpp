...
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? hl64ton(host64) : host64;
//}

//inline uint32_t hostToNetwork32(uint32_t host32)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? htonl(host32) : host32;
//}

//inline uint16_t hostToNetwork16(uint16_t host16)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? htons(host16) : host16;
//}

//inline uint64_t networkToHost64(uint64_t net64)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? ntohl64(net64) : net64;
//}

//inline uint32_t networkToHost32(uint32_t net32)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? ntohl(net32) : net32;
//}

//inline uint16_t networkToHost16(uint16_t net16)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? ntohs(net16) : net16;
//}
//#elif defined BCF_PLATFORM_LINUX
//inline uint64_t hostToNetwork64(uint64_t host64)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? htobe64(host64) : host64;
//}
//inline uint32_t hostToNetwork32(uint32_t host32)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? htobe32(host32) : host32;
//}

//inline uint16_t hostToNetwork16(uint16_t host16)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? htobe16(host16) : host16;
//}

//inline uint64_t networkToHost64(uint64_t net64)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? be64toh(net64) : net64;
//}

//inline uint32_t networkToHost32(uint32_t net32)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? be32toh(net32) : net32;
//}

//inline uint16_t networkToHost16(uint16_t net16)
//{
//    return !(BYTE_ORDER == BIG_ENDIAN) ? be16toh(net16) : net16;
//}
//#elif defined BCF_PLATFORM_DARWIN || defined BCF_PLATFORM_FREEBSD
//inline uint64_t hostToNetwork64(uint64_t host64)
//{
...
#ifdef __cplusplus
template <typename T>
uint8_t* serialize(uint8_t* buf, T value, int host_endian = LITTLE_ENDIAN,
                   int buf_endian = BIG_ENDIAN)
{
